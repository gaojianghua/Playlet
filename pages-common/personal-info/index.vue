<template>
	<view class="page">
		<!-- 顶部导航栏 -->
		<m-navbar :borderBottom="false" bgColor="transparent" textColor="#fff" value="page.个人信息" i18n></m-navbar>
		<!-- 内容区域 -->
		<view class="content d-flex a-center j-center flex-column pt-5 px-3">
			...
			<view class="user-avatar flex-shrink border-2 border-white mr-2">
				<u-image radius="100" width="160rpx" height="160rpx"
			...
			<view id="info" class="d-flex a-center j-center">
				<u-input type="text"
					...
					<view slot="prefix" class="area d-flex a-center mr-1">
						<u-icon name="account-fill" color="#EE7623" size="24"></u-icon>
					</view>
				</u-input>
			</view>
		</m-modal>
